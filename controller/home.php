...
if (isset($_SESSION['user'])) {
    foreach ($players as $p) {
        if ($p['stay']) {
            ...
            $playersList .= '<div class="crane">' . $p['crane'] . ' %</div><div class="dons">';

            $playersList .= '</div><div class="base"><div class="donsB">';

            $playersList .= '</div><div class="img_base"><div class="perkHaut">' . $bh . '</div>' . $base . '<div class="perkGauche">' . $bg . '</div><div class="perkDroite">' . $bd . '</div></div><div class="perkListB">' . $perkbase . '</div></div>';
            $playersList .= '<div class="tresor"><div class="donsT">';

            $playersList .= '</div><div class="img_tresor"><div class="perkHaut">' . $th . '</div>' . $tresor . '<div class="perkGauche">' . $tg . '</div>
    <div class="perkDroite">' . $td . '</div>
    </div>
    <div class="perkListT">' . $perktresor . '</div></div>';
            $playersList .= '<div class="guerre"><div class="donsG">';

            $playersList .= '</div><div class="img_guerre"><div class="perkHaut">' . $gh . '</div>' . $guerre . '<div class="perkGauche">' . $gg . '</div>
    <div class="perkDroite">' . $gd . '</div>
    </div><div class="perkListG">' . $perkguerre . '</div></div></div>';
        }
    }
} else {
